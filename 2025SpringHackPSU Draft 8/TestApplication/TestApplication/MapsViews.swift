...
struct MapsGalleryView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .fullScreenCover(isPresented: $showLiveScan) {
                // Connects to existing LIDAR scanner implementation
                LiveScanView(mapEnvironment: liveEnvironment)
            }
        }
        .gesture(
...
// Placeholder for Live Scan View - would connect to existing implementation
struct LiveScanView: View {
    ...
    var body: some View {
        ZStack {
            // This would use existing RoomScanner or ARViewContainer
