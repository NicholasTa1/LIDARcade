...
struct MapsGalleryView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .fullScreenCover(isPresented: $showLiveScan) {
                // This connects to the RoomScanner implementation
                RoomScannerView()
...
// Live Scan View that transitions to game after scanning
struct LiveScanView: View {
    ...
    var body: some View {
        ZStack {
            // Use the RoomScanner as background
            RoomScannerView()
                .edgesIgnoringSafeArea(.all)
        ...
        .fullScreenCover(isPresented: $startGame) {
            // Direct to game with the live environment
            GameView(mapEnvironment: mapEnvironment)
        }
    }
}